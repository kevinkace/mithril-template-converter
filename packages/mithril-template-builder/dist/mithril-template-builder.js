...
var DOMParser = /*#__PURE__*/Object.freeze({
	default: domParser,
...
var jsdomGlobal = function globalJsdom (html, options) {
  if (html === undefined) {
    html = defaultHtml;
  }
  ...
  if (commonjsGlobal.navigator &&
    commonjsGlobal.navigator.userAgent &&
    commonjsGlobal.navigator.userAgent.indexOf('Node.js') > -1 &&
    commonjsGlobal.document &&
    typeof commonjsGlobal.document.destroy === 'function') {
    return commonjsGlobal.document.destroy
  }

  var jsdom$$1 = jsdom;
  var document = new jsdom$$1.JSDOM(html, options);
  var window = document.window;

  keys.forEach(function (key) {
    commonjsGlobal[key] = window[key];
  });

  commonjsGlobal.document = window.document;
  commonjsGlobal.window = window;
  window.console = commonjsGlobal.console;
  document.destroy = cleanup;

  function cleanup () {
    keys.forEach(function (key) { delete commonjsGlobal[key]; });
  }
